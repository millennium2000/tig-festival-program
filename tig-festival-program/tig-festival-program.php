...
define('TIG_FESTIVAL_PROGRAM_VERSION', '0.7.3');
...
{
    return [
        ['id' => 'main_stage',   'label' => 'FÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂszÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ­npad',    'color' => '#2b72b8', 'text_color' => '#ffffff'],
        ['id' => 'side_stage',   'label' => 'MellÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ©kszÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ­npad','color' => '#5f96cf', 'text_color' => '#ffffff'],
        ['id' => 'workshop',     'label' => 'Workshop',     'color' => '#f2e799', 'text_color' => '#0f2133'],
        ['id' => 'kids_zone',    'label' => 'GyerekzÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ³na',   'color' => '#ffd200', 'text_color' => '#0f2133'],
        ['id' => 'food_court',   'label' => 'ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂtkezÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ©si tÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ©r', 'color' => '#c9d7e6', 'text_color' => '#0f2133'],
    ];
}
...
{
    return [
        ['id' => 'main',        'label' => 'FÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ program'],
...
{
    return [
        ['time' => '09:00', 'note' => 'KapunyitÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¡s', 'events' => []],
        ['time' => '09:30', 'note' => '', 'events' => [
            ['venue' => 'kids_zone',  'title' => 'Gyermekprogramok kezdete', 'type' => 'continuous'],
            ['venue' => 'food_court', 'title' => 'Reggeli bÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¼fÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ© nyitÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¡s',      'type' => 'continuous'],
        ]],
        ['time' => '10:00', 'note' => '', 'events' => [
            ['venue' => 'main_stage', 'title' => 'MegnyitÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ³ ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¼nnepsÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ©g',        'type' => 'main'],
            ['venue' => 'workshop',   'title' => 'Workshop A ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ BemutatkozÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¡s','type' => 'workshop'],
        ]],
        ['time' => '11:00', 'note' => '', 'events' => [
            ['venue' => 'main_stage', 'title' => 'VendÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ©gelÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂadÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ³ I.',           'type' => 'main'],
            ['venue' => 'side_stage', 'title' => 'Akusztikus koncert',        'type' => 'main'],
            ['venue' => 'workshop',   'title' => 'Workshop B ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ CsapatjÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¡tÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ©k', 'type' => 'workshop'],
        ]],
        ['time' => '12:30', 'note' => 'EbÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ©dszÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¼net', 'events' => [
            ['venue' => 'food_court', 'title' => 'EbÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ©d', 'type' => 'continuous'],
        ]],
        ['time' => '14:00', 'note' => '', 'events' => [
            ['venue' => 'main_stage', 'title' => 'FÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ program ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ Csapatverseny',  'type' => 'main'],
            ['venue' => 'side_stage', 'title' => 'InteraktÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ­v bemutatÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ³',         'type' => 'main'],
            ['venue' => 'kids_zone',  'title' => 'KÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ©zmÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ±ves foglalkozÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¡s',        'type' => 'workshop'],
        ]],
        ['time' => '16:00', 'note' => '', 'events' => [
            ['venue' => 'main_stage', 'title' => 'DÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ­jÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¡tadÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ³ ceremÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ³nia',          'type' => 'main'],
        ]],
        ['time' => '17:00', 'note' => '', 'events' => [
            ['venue' => 'main_stage', 'title' => 'ZÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¡rÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ³ koncert',                'type' => 'main'],
            ['venue' => 'food_court', 'title' => 'Esti bÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¼fÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ©',                   'type' => 'continuous'],
        ]],
        ['time' => '19:00', 'note' => 'RendezvÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ©ny vÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ©ge', 'events' => []],
    ];
}
...
function tig_festival_program_shortcode(array $atts = []): string
{
    ...
    ob_start();
        // Shortcode attribÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂºtumok ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¡tadÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¡sa a template-nek
include $template;
    $html = trim((string) ob_get_clean());

    if ($html === '' && current_user_can('manage_options')) {
        return '<div class="tig-program tig-program-error">DG Program: a shortcode lefutott, de nem kÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ©szÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¼lt megjelenÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ­thetÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ HTML.</div>';
    }
      ...
      <div class="tig-desktop-view">
        <div class="tig-program-table-wrap">
          <table class="tig-program-table tig-program-table-dynamic">
            <thead>
              <tr>
                <th class="tig-program-time-head">IdÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂpont</th>
                <?php foreach ($venues as $venue) : ?>
                      ...
                      <?php foreach ($venue_events as $event) : ?>
                        ...
                        <div class="tig-program-event">
                          ...
                          <?php if (!empty($event['end_time'])) : ?>
                            <span class="tig-program-time-range"><?php echo esc_html(($row['time'] ?? '') . 'ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ' . $event['end_time']); ?></span>
                          <?php endif; ?>
...
function tig_festival_program_handle_admin_save(): void
{
    if (!current_user_can('edit_posts')) {
        wp_die(esc_html__('Nincs jogosultsÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¡god a program szerkesztÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ©sÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ©hez.', 'tig-festival-program'));
    }
    ...
    // Napos struktÃÂÃÂºra frissÃÂÃÂ­tÃÂÃÂ©se
...
function tig_festival_program_handle_admin_reset(): void
{
    if (!current_user_can('manage_options')) {
        wp_die(esc_html__('Nincs jogosultsÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¡god ehhez a mÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ±velethez.', 'tig-festival-program'));
    }
...
{
    if (!current_user_can('manage_options')) {
        wp_send_json_error(['message' => 'Nincs jogosultsÃ¡god.'], 403);
    }
...
{
    if (!current_user_can('manage_options')) {
        wp_die(esc_html__('Nincs jogosultsÃ¡god.', 'tig-festival-program'));
    }
...
function tig_festival_program_render_admin_page(): void
{
    ...
    <div class="wrap tig-admin-wrap">
        <h1>DG Program szerkesztÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ</h1>

        <?php if (isset($_GET['reset']) && $_GET['reset'] === '1') : ?>
                <div class="notice notice-warning is-dismissible">
                    <p>ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂsszes adat tÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¶rÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¶lve. Az alapÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ©rtelmezett adatok visszaÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¡llnak elsÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ betÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¶ltÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ©skor.</p>
                </div>
                <?php endif; ?>
        ...
        <?php endif; ?>
                ...
                <div class="notice notice-success is-dismissible">
                    <p>Program sikeresen importÃ¡lva.</p>
                </div>
                <?php endif; ?>
                <?php if (isset($_GET['import_error'])) : ?>
                <div class="notice notice-error is-dismissible">
                    <p>Import hiba: <?php echo esc_html($_GET['import_error'] === 'invalid_json' ? 'ÃrvÃ©nytelen JSON fÃ¡jl.' : 'Ãres fÃ¡jl.'); ?></p>
                </div>
                <?php endif; ?>
                

        <p>Az elsÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ oszlop az idÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂpont, utÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¡na a lent megadott helyszÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ­nek jelennek meg oszlopkÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ©nt. A tag-ek opcionÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¡lisak, bÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂvÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ­thetÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂk ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ©s ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¡tÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ­rhatÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ³k. TÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¶bb idÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂsÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¡von ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¡t tartÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ³ programnÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¡l add meg a vÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ©ge idÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂpontot.</p>
        ...
        <form method="post" action="<?php echo esc_url(admin_url('admin-post.php')); ?>">
            ...
            <div class="tig-admin-toolbar">
                <button type="button" class="button button-secondary" data-tig-add-venue>ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂj helyszÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ­n</button>
                <button type="button" class="button button-secondary" data-tig-add-type>ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂj tag</button>
                <button type="button" class="button button-secondary" data-tig-add-row>ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂj idÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂpont</button>
                <button type="submit" class="button button-primary">Program mentÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ©se</button>
                ...
                <button
                    ...
                    data-confirm="<?php echo esc_attr('Biztosan tÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¶rlÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¶d az ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¶sszes helyszÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ­nt, programot ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ©s beÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¡llÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ­tÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¡st? Ez a mÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ±velet nem vonhatÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ³ vissza.'); ?>"
                ...
                >ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂsszes adat tÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¶rlÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ©se</button>
                ...
                >&#8595; ExportÃ¡lÃ¡s (JSON)</button>

                <label class="button button-secondary tig-import-label" title="JSON fÃ¡jl importÃ¡lÃ¡sa">
                    &#8593; ImportÃ¡lÃ¡s (JSON)
            ...
            <section class="tig-admin-panel">
                <h2>HelyszÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ­nek</h2>
            ...
            <section class="tig-admin-panel">
                <h2>IdÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂpontok ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ©s programok</h2>
    ...
    <script>
        (function () {
            ...
            // Reset gomb kezelÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ
            (function () {
...
function tig_festival_program_render_admin_venue($venue_index, array $venue): void
{
    ...
    <div class="tig-admin-venue" data-tig-venue>
        ...
        <div class="tig-admin-field">
            <label>HelyszÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ­n neve</label>
            <input type="text" name="dg_venues[<?php echo esc_attr((string) $venue_index); ?>][label]" value="<?php echo esc_attr($venue['label'] ?? ''); ?>" placeholder="Pl. NagyszÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ­npad">
        </div>
        <div class="tig-admin-field">
            <label>HÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¡ttÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ©rszÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ­n</label>
            <input type="color" name="dg_venues[<?php echo esc_attr((string) $venue_index); ?>][color]" value="<?php echo esc_attr($venue['color'] ?? '#eef3f7'); ?>">
        </div>
        <div class="tig-admin-field">
            <label>SzÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¶vegszÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ­n</label>
        ...
        <div class="tig-admin-actions">
            <button type="button" class="button button-link-delete" data-tig-remove-venue>HelyszÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ­n tÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¶rlÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ©se</button>
        </div>
    </div>
    <?php
}
...
function tig_festival_program_render_admin_type($type_index, array $type): void
{
    ...
    <div class="tig-admin-type" data-tig-type>
        ...
        <div class="tig-admin-field">
            ...
            <input type="text" name="dg_program_types[<?php echo esc_attr((string) $type_index); ?>][label]" value="<?php echo esc_attr($type['label'] ?? ''); ?>" placeholder="Pl. FÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ program">
        </div>
        <div></div>
        <div></div>
        <div class="tig-admin-actions">
            <button type="button" class="button button-link-delete" data-tig-remove-type>Tag tÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¶rlÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ©se</button>
        </div>
    </div>
    <?php
}
...
function tig_festival_program_render_admin_row($row_index, array $row, array $venues, array $types): void
{
    ...
    <section class="tig-admin-row" data-tig-row data-row-index="<?php echo esc_attr((string) $row_index); ?>">
        <div class="tig-admin-row-head">
            <div class="tig-admin-field">
                <label>IdÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂpont</label>
                <input type="time" name="dg_schedule[<?php echo esc_attr((string) $row_index); ?>][time]" value="<?php echo esc_attr($row['time'] ?? ''); ?>">
            </div>
            <div class="tig-admin-field">
                <label>IdÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂpont megjegyzÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ©s</label>
                <input type="text" name="dg_schedule[<?php echo esc_attr((string) $row_index); ?>][note]" value="<?php echo esc_attr($row['note'] ?? ''); ?>" placeholder="Pl. KapunyitÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¡s">
            </div>
            <div class="tig-admin-row-actions">
                <button type="button" class="button" data-tig-add-event>Program hozzÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¡adÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¡sa</button>
                <button type="button" class="button button-link-delete" data-tig-remove-row>IdÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂpont tÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¶rlÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ©se</button>
            </div>
        </div>
...
function tig_festival_program_render_admin_event($row_index, $event_index, array $event, array $venues, array $types): void
{
    ...
    <div class="tig-admin-event" data-tig-event>
        <div class="tig-admin-field">
            <label>HelyszÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ­n</label>
        ...
        <div class="tig-admin-field">
            <label>Program cÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ­me</label>
        ...
        <div class="tig-admin-field">
            <label>VÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ©ge (opcionÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¡lis)</label>
        ...
        <div class="tig-admin-event-actions">
                    ...
                    <div class="tig-admin-field tig-admin-field--full">
                        ...
                        <textarea name="dg_schedule[<?php echo esc_attr((string) $row_index); ?>][events][<?php echo esc_attr((string) $event_index); ?>][description]" rows="2" placeholder="Rövid leírás a programpontról..."><?php echo esc_textarea($event['description'] ?? ''); ?></textarea>
                    </div>
                    <div class="tig-admin-field">
                    ...
                    <button type="button" class="button button-link-delete" data-tig-remove-event>Program tÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¶rlÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ©se</button>
        </div>
    </div>
    <?php
}
